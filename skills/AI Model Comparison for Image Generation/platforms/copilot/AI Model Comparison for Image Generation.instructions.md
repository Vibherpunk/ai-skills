# Copilot Instructions: Ai Model Comparison For Image Generation
Description: This skill enables you to compare different AI image generation models using the same prompts and settings to evaluate their performance and quality. It includes selecting models, configuring settings, generating images, and analyzing results.
...
1. **[Which AI Image Model Creates the Best Results | SeaArt](https://www.youtube.com/watch?v=hVXHl0R5MuA)** by AI Mastery Tutorial