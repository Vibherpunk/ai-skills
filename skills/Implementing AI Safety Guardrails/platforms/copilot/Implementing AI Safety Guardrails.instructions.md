# Copilot Instructions: Implementing Ai Safety Guardrails
Description: A comprehensive skill for implementing guardrails to protect generative AI systems from hallucinations and prompt injection attacks.
