# Copilot Instructions: Claude Academic Workflow
Description: A comprehensive skill for leveraging Claude's academic and research capabilities, including project management, skill integration, connector usage, and co-work features.
...
# Code Examples
Here are some practical code and prompt examples for using Claude in academic tasks:
```markdown
### Literature Review Helper Skill
- **Prompt**: "Generate a literature review on [topic]. Include references from Consensus."
- **Instructions**: "Follow the standard review process with 10 searches. Ensure all references are accurate and relevant."
...
- **Prompt**: "Give me a template of a scientific poster presentation, A0 size."
- **Instructions**: "Include sections for abstract, methods, results, and conclusion. Use deep teal and copper as the color theme."

### Co-Work Task
- **Prompt**: "Perform a literature review on OPV devices."
- **Instructions**: "Use the literature review helper skill and Consensus connector. Provide manual approvals for each step."
```
These examples illustrate how to structure prompts and instructions for various academic tasks using Claude.
...
# Practical Guide
To effectively use Claude for academic tasks, follow these practical steps:
1. **Create a Project**: Start by creating a project in Claude. This helps organize tasks and provides a space for custom instructions and file uploads.
2. **Add Files**: Upload guidelines, references, and other necessary documents to the project. This ensures Claude has all the context it needs.
3. **Set Up Connectors**: Integrate external tools like Consensus using connectors. This enables Claude to pull in relevant data and papers for your research.
4. **Import Skills**: Import pre-made skills or create custom ones for repetitive tasks like literature reviews.
5. **Use Co-Work**: Utilize the co-work feature for agentic AI tasks. This allows Claude to perform multiple steps autonomously, with optional manual approvals.
6. **Design Templates**: Use Claude's design feature to create scientific posters and abstracts. Upload institutional templates for consistency.
By following these steps, you can streamline your academic workflows and leverage Claude's capabilities effectively.
...
1. **[The Real Reason Researchers Are Switching to Claude in 2026 (Projects, Skills, Cowork, Consensus)](https://www.youtube.com/watch?v=QqNXf7DfSpA)** by Andy Stapleton